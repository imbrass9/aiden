...
> 🟡 **이 페이지는 원리 소개(맛보기)입니다.** 라이팅 룸 생성·판정 엔진 전체는 에이든에게 컨설팅을 진행하면 제공합니다.
...
cp -r aiden/skills/humantouch-writing ~/.claude/skills/
```
...
git clone https://github.com/imbrass9/aiden.git
Copy-Item -Recurse aiden\skills\humantouch-writing "$env:USERPROFILE\.claude\skills\"
```
